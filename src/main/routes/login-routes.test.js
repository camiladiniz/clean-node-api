...
describe('Login Routes', function () {
    ...
    describe('POST /signup', function () {
        ...
        test('Should return 200 on signup', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    describe('POST /login', function () {
        test('Should return 200 on login', function () { return __awaiter(void 0, void 0, void 0, function () {
            var password;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (bcrypt_1.hash('123', 12))];
                    case 1:
                        password = _a.sent();
        ...
        test('Should return 401 on login', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, supertest_1["default"](app_1["default"])
                            .post('/api/login')
