...
describe('Survey Routes', function () {
    ...
    describe('POST /surveys', function () {
        ...
        test('Should return 403 on add survey without accessToken', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        test('Should return 204 on add survey with valid accessToken', function () { return __awaiter(void 0, void 0, void 0, function () {
            var accessToken;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    describe('GET /surveys', function () {
        // verifica se o body é parseado e o server entenda
        test('Should return 403 on load surveys without accessToken', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, supertest_1["default"](app_1["default"])
                            .get('/api/surveys')
        ...
        test('Should return 204 on load surveys with valid accessToken', function () { return __awaiter(void 0, void 0, void 0, function () {
            var accessToken;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, makeAccessToken()];
