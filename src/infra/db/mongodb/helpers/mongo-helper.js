...
exports.MongoHelper = {
    ...
    map: function (data, collection) {
        var insertedId = collection.insertedId;
        var _id = data._id, items = __rest(data, ["_id"]);
        return Object.assign({}, items, { id: insertedId });
    },
    mapGet: function (data) {
        var _id = data._id, items = __rest(data, ["_id"]);
        return Object.assign({}, items, { id: _id });
    },
    mapCollection: function (data, collection) {
        return collection.map(function (c) { return exports.MongoHelper.mapGet(c); });
    }
};
