...
var log_mongo_repository_1 = require("./log-mongo-repository");
...
describe('Log Mongo Repository', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, errorCollection.deleteMany({})];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    test('Should create an error log on success', function () { return __awaiter(void 0, void 0, void 0, function () {
        var sut, count;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    sut = makeSut();
                    return [4 /*yield*/, sut.logError('any_error')];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, errorCollection.countDocuments()];
                case 2:
                    count = _a.sent();
                    expect(count).toBe(1);
                    return [2 /*return*/];
